...
/**
 * Test case for class \Libeo\LboServicesEnLigne\Domain\Model\Service.
 *
...
class ServiceTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Libeo\LboServicesEnLigne\Domain\Model\Service
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \Libeo\LboServicesEnLigne\Domain\Model\Service();
	}
